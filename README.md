...
Ini adalah hasil atau tampilan dari **Header** Disitu juga saya menambahkan **Box-Shadow-lg**  atau ***large*** dan juga padding atas bawah atau dalam **bootstrap** yaitu **py** dan juga beberapa class untuk membuat nya dan simpan **code** dalam ***body***
...
Membuat Navigasi dengan **class "navbar"** **bootstrap** telah menyediakan semua nya hanya pada kita nya saja yang mendesain sesuai kebutuhan,seperti di atas memakai ***navigasi*** dengan **class navbar** dan beberapa class lain nya untuk mendukung navigasi nya seperti contoh **nav class active** di dalam element html di **bootstrap** kita dapat menggunakan banyak **class** dalam mendesain yang tersedia di bootstrap.
...
Langkah selanjutnya yaitu membuat **card body** dengan isi **section description** atau isi konten deskripsi saya menggunakan div dengan class card kemudian saya tambahkan inline css untuk sedikit mengatur sesuai layout nya dan juga menggunakan beberapa class di bootstrap nya seperti contoh gambar di atas.
...
## WIDGET TEXT
![widget_text](img/widget_text.png)

**PENJELASAN**

Selanjutnya yaitu membuat **widget text** pada colom yang sama dengan **widget header** dan menggunakan beberapa class dibootstrap dalam membuat nya secara otomatis seperti contoh gambar di atas dan code dibawah.
...
![content2-section1](img/row_content.png)

**PENJELASAN**

Pada bagian ini saya membuat **row** baru dan juga **col** baru dengan menambahkan ***class*** dan juga inline css untuk sedikit memperindah seperti gambar di atas dan code dibawah.
...
![content3-section2](img/row_content_2.png)
...
![card_footer](img/card_footer.png)
